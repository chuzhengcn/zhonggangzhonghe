...
<head>
	...
	<title>Inceptio - Blog Post - Image</title>
</head>
    ...
    <section id="content">
        ...
        <section id="main" class="blog-entry-list three-fourths">
            ...
            <article class="entry clearfix">
            	<!-- begin entry image -->
            	<a class="entry-image lightbox" href="images/entries/full-size/southern-alps.jpg" title="Post Title"><span class="overlay zoom"></span><img src="images/entries/700x300/southern-alps-700x300.png" alt=""></a>
                <!-- end entry image -->
                ...
                <div class="entry-body">
                	<!-- begin entry title -->
                    <h2 class="entry-title">Responsive Web Design Techniques, Tools and Design Strategies</h2>
                    <!-- end entry title -->
            ...
            <section class="related-posts-wrap">
            	<h3>Related Posts</h3>
                <ul class="square">
                    <li><a href="blog-post-slider.php">Designing For Device Orientation: From Portrait To Landscape</a></li>
