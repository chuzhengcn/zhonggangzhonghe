...
<head>
	...
	<title>Inceptio - Blog Post - No Media</title>
</head>
        ...
        <section id="main" class="blog-entry-list three-fourths">
            ...
            <article class="entry clearfix">
                ...
                <div class="entry-body">
                	<!-- begin entry title -->
                    <h2 class="entry-title">The Creative Way to Maximize Design Ideas with Type</h2>
                    <!-- end entry title -->
