...
<head>
	...
	<title>Inceptio - Portfolio Item - Full Width</title>
</head>
        ...
        <section>
                ...
                <div class="entry-slider">
                    <div id="flexslider-portfolio-item" class="flex-container">
                        <div class="flexslider">
                            <ul class="slides">
                                <li><a class="lightbox" data-fancybox-group="sunrise" href="images/entries/full-size/sunrise.jpg" title="Image Title"><span class="overlay zoom"></span><img src="images/entries/940x598/sunrise-940x598.png" alt=""></a></li>
                    			<li><a class="lightbox" data-fancybox-group="sunrise" href="images/entries/full-size/southern-alps.jpg" title="Image Title"><span class="overlay zoom"></span><img src="images/entries/940x598/southern-alps-940x598.png" alt=""></a></li>
                    			<li><a class="lightbox" data-fancybox-group="sunrise" href="images/entries/full-size/canoes-on-moraine-lake.jpg" title="Image Title"><span class="overlay zoom"></span><img src="images/entries/940x598/canoes-on-moraine-lake-940x598.png" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                </div>	
            ...
            <div class="three-fourths">
                <div class="project-description">
                    ...
                    <p>Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam eget ligula velit, vitae convallis ipsum. Curabitur ac orci vitae mauris tincidunt tincidunt. Sed dui elit, pellentesque vel commodo at, fringilla ac leo. Proin aliquam tempor eleifend. Mauris venenatis interdum ante, eget sodales ipsum faucibus vestibulum. Mauris porttitor, est et tempus varius, erat libero dignissim augue, quis luctus arcu lectus a enim. Praesent dapibus urna at eros molestie fermentum. Suspendisse vulputate rhoncus lorem eu porta. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.  Integer dignissim, lacus at rhoncus aliquam, tellus risus tristique arcu, eu placerat nisi ipsum ac eros. Sed non risus massa, non venenatis eros. Vestibulum nec eros enim, eu tincidunt nulla. Suspendisse vel neque ac dolor bibendum cursus. Etiam ipsum tortor, tincidunt vitae malesuada eu, ultricies a quam. Fusce sed ipsum est.</p>
                    <p>Nam mattis ante at erat lacinia semper. Nunc eleifend euismod nunc, non hendrerit tortor adipiscing et. Sed est massa, euismod id ullamcorper at, molestie sit amet neque. Maecenas sagittis vestibulum luctus. Donec tempor condimentum porttitor. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Praesent rhoncus lobortis sapien, et tincidunt mauris placerat vel. Ut vitae est lectus. Morbi ac arcu quam. Nunc nec ligula at ipsum porta vehicula vitae ut tortor. Cras ut elementum elit. Curabitur mattis aliquet nisl ut hendrerit. Aliquam at elit turpis, ac iaculis quam. Vivamus ut nisi justo. Sed ullamcorper elementum purus ut volutpat. Sed congue varius semper. Praesent mollis nisi ultricies sem accumsan tempus convallis orci vulputate. Aenean nec est quis arcu varius blandit in in elit. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.</p>		
                </div>
            </div>
