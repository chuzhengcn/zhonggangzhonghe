...
<head>
	...
	<title>Inceptio - Blog Post - Video</title>
</head>
        ...
        <section id="main" class="blog-entry-list three-fourths">
            ...
            <article class="entry clearfix">
                ...
                <div class="entry-body">
                	<!-- begin entry title -->
                    <h2 class="entry-title">Useful Talks and Videos from Web Design Conferences</h2>
                    <!-- end entry title -->
