...
<head>
	...
	<title>Inceptio - Blog Post - Slider</title>
</head>
        ...
        <section id="main" class="blog-entry-list three-fourths">
            ...
            <article class="entry clearfix">
                ...
                <div class="entry-slider">
                    <div id="flexslider-portfolio-item" class="flex-container">
                        <div class="flexslider">
                            <ul class="slides">
                                <li><a class="lightbox" data-fancybox-group="spring" href="images/entries/full-size/spring.jpg" title="Post Title"><span class="overlay zoom"></span><img src="images/entries/700x300/spring-700x300.png" alt=""></a></li>
                                <li><a class="lightbox" data-fancybox-group="spring" href="images/entries/full-size/sailing.jpg" title="Post Title"><span class="overlay zoom"></span><img src="images/entries/700x300/sailing-700x300.png" alt=""></a></li>
                                <li><a class="lightbox" data-fancybox-group="spring" href="images/entries/full-size/sunrise.jpg" title="Post Title"><span class="overlay zoom"></span><img src="images/entries/700x300/sunrise-700x300.png" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                </div>	
                ...
                <div class="entry-body">
                	<!-- begin entry title -->
                    <h2 class="entry-title">Designing For Device Orientation: From Portrait To Landscape</h2>
                    <!-- end entry title -->
            ...
            <section class="related-posts-wrap">
            	<h3>Related Posts</h3>
                <ul class="square">
                    <li><a href="blog-post-image.php">Responsive Web Design Techniques, Tools and Design Strategies</a></li>
                    <li><a href="blog-post-video.php">Useful Talks and Videos from Web Design Conferences</a></li>
                    <li><a href="blog-post-no-media.php">The Creative Way to Maximize Design Ideas with Type</a></li>
                </ul>
            </section>
            <!-- end related posts -->
                                ...
                                <ol class="children">
                                    ...
                                    <li class="comment">
                                        ...
                                        <div id="comment-3" class="comment-wrap">
                                            ...
                                            <div class="comment-details">
                                                <div class="comment-author post-author"><a href="#">admin <span>(Author)</span></a></div>
